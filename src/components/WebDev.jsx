			...
			<div className={classes.projectsWrapper}>	
				<div className={"row align-items-center " + classes.projectsWrapper}>
					...
					<div className={"col-12 " + classes.projectSection}>
						...
						<h5>Link: <a target="_blank" rel="noopener noreferrer" className={classes.linkStyle} href="https://strat-map.herokuapp.com/">strat-map.herokuapp.com</a></h5>
					</div>
					<div className={"col-12 " + classes.projectSection}>
						<h3>Portfolio</h3>
						<p className={classes.paragraph}>
					...
					<div className={"col-12 " + classes.projectSection}>
						...
						<h5>Link: <a target="_blank" rel="noopener noreferrer" className={classes.linkStyle} href="https://marine-species-fossil-database.herokuapp.com">marine-species-fossil-database.herokuapp.com</a></h5>										
					</div>	
					<div className={"col-12 " + classes.projectSection}>
